                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <form action="saveusers" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="name" class=" form-control-label">Enter Name</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="firstname" placeholder="Text" class="form-control"><small class="form-text text-muted">Please enter Name</small></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="lastname" class=" form-control-label">Enter Last Name</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="lastname" placeholder="Text" class="form-control"><small class="form-text text-muted">Please Enter  LastName</small></div>
                          </div>
                          <div class="row form-group">
                          ...
                          <input type="submit" class="btn btn-primary btn-sm" name="">
